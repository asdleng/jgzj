...
for model_path in "${GENERAL_MODEL}" "${TRASH_MODEL}" "${SMOKING_CANDIDATE_MODEL}" "${SMOKING_CLS_MODEL}"; do
...
export YOLO_PRELOAD_MODELS="${GENERAL_MODEL},${TRASH_MODEL},${SMOKING_CANDIDATE_MODEL},${SMOKING_CLS_MODEL}"
