...
for model_path in "${PERSON_MODEL}" "${GENERAL_MODEL}" "${TRASH_MODEL}" "${FIRE_SMOKE_MODEL}" "${PET_MODEL}" "${PHONE_MODEL}" "${STALL_MODEL}" "${FISHING_ROD_MODEL}" "${PERSON_BEHAVIOR_CLS_MODEL}"; do
...
export YOLO_PRELOAD_MODELS="${PERSON_MODEL},${GENERAL_MODEL},${TRASH_MODEL},${FIRE_SMOKE_MODEL},${PET_MODEL},${PHONE_MODEL},${STALL_MODEL},${FISHING_ROD_MODEL},${PERSON_BEHAVIOR_CLS_MODEL}"
