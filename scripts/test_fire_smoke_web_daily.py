...
from run_fire_smoke_web_daily import (  # noqa: E402
...
class FireSmokeWebDailyTest(unittest.TestCase):
    ...
    def test_validation_accepts_guarded_one_to_one_dataset(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            review = [
                {
                    "image_sha256": "a" * 64,
                    "collection_bucket": "fire_building",
                    "scene": "positive",
                    "box_count": 1,
                ...
                {
                    "image_sha256": "b" * 64,
                    "collection_bucket": "hard_negative_fog_building",
                    "scene": "hard_negative",
                    "box_count": 0,
                    "training_eligible": False,
                },
    ...
    def test_validation_rejects_positive_hard_negative(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            write_jsonl(dataset / "qwen_review_manifest.jsonl", [{
                "image_sha256": sha,
                "collection_bucket": "hard_negative_steam",
                "scene": "positive",
                "training_eligible": False,
            }])
            (dataset / "training_guard.json").write_text('{"training_eligible":false}\n', encoding="utf-8")
    ...
    def test_validation_rejects_training_guard_enablement(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            write_jsonl(dataset / "qwen_review_manifest.jsonl", [{
                "image_sha256": sha,
                "collection_bucket": "fire_vehicle",
                "scene": "hard_negative",
                "training_eligible": False,
            }])
