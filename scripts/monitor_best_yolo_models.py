...
TARGETS = {
    ...
    "vehicle_yolo": {
        ...
        "static_only": True,
        "static_model_family": "yolo11s-closed-loop-20260719_150443",
        "static_metric_source": "closed_loop_test_20260714_20260718",
        "static_source_run": "/home/sari/jgzj_yolo_daily_closed_loop/runs/vehicle_yolo/vehicle_yolo_20260719_150443_20260719_150443_20260719_074333",
        "static_best_weight": "/home/sari/jgzj_yolo_daily_closed_loop/runs/vehicle_yolo/vehicle_yolo_20260719_150443_20260719_150443_20260719_074333/weights/best.pt",
        "static_metrics": {
            "val_precision": 0.6974491410815677,
            "val_recall": 0.6588892709766162,
            "val_map50": 0.7157957821642364,
            "val_map50_95": 0.4580383578883942,
            "test_precision": 0.6772021735649634,
            "test_recall": 0.6796766220528571,
            "test_map50": 0.7073462866524023,
            "test_map50_95": 0.4555357657323535,
        },
        "static_note": "车辆识别闭环候选 20260719_150443：训练使用 20260714-20260717 replay 与 20260718 新数据，正/负样本图 3766/5649。闭环 test 上 P/R/mAP50/mAP50-95=0.677/0.680/0.707/0.456；同一 test 重跑旧权重为 0.500/0.271/0.264/0.157，分别提升 17.73/40.85/44.31/29.84 个百分点。该指标不可与历史 different-dataset 指标直接比较。",
        "roots": [
            "/home/sari/jgzj_yolo_runs_reliable_vehicle_20260704",
    ...
    "pet_yolo": {
        ...
        "static_only": True,
        "static_status": "deployed",
        "static_model_family": "balancedneg_full20_20260729_161945",
        "static_metric_source": "finetune_pet_best_test",
        "static_source_run": "/home/admin1/jgzj/.runtime/finetune/results/20260729_161945_pet_yolo_finetune_pet_balancedneg_full20",
        "static_best_weight": "/home/admin1/jgzj/.runtime/finetune/results/20260729_161945_pet_yolo_finetune_pet_balancedneg_full20/weights/best.pt",
        "static_metrics": {
            "test_precision": 0.9123116083206606,
            "test_recall": 0.8888888888888888,
            "test_map50": 0.9207728350626094,
            "test_map50_95": 0.7904537004194098,
            "val_precision": 0.9384007334870578,
            "val_recall": 0.9936125011707229,
            "val_map50": 0.9929059449866904,
            "val_map50_95": 0.836986866263681,
        },
        "static_note": "finetune_pet 二次整合数据集，负样本按 7/7/6 平均放入 train/val/test；完整训练 20 epoch，best.pt 来自第 7 轮。",
        "static_training_trends": [
            {
                "day": "2026-07-29",
                "task_id": "pet_yolo",
                "model_family": "reviewed_finetune_20260729_102722",
                "status": "completed",
                "metric_source": "reviewed_finetune_test",
                "score": 0.7309942013744376,
                "test_precision": 0.9774507626661848,
                "test_recall": 0.8666666666666667,
                "test_map50": 0.9613694432001413,
                "test_map50_95": 0.7309942013744376,
                "val_precision": 0.9538221631014725,
                "val_recall": 0.918128139866511,
                "val_map50": 0.9725110856721798,
                "val_map50_95": 0.7305968695011533,
                "started_at": "2026-07-29T02:34:48.942632",
                "finished_at": "2026-07-29T02:35:52.763065",
                "source_run": "/home/admin1/jgzj/.runtime/finetune/results/20260729_102722_pet_yolo_reviewed_finetune",
                "best_weight": "/home/admin1/jgzj/.runtime/finetune/results/20260729_102722_pet_yolo_reviewed_finetune/pet_yolo_reviewed_finetune_20260729_102722_pet_yolo_reviewed_finetune_best.pt",
                "run_count": 1,
            },
            {
                "day": "2026-07-29",
                "task_id": "pet_yolo",
                "model_family": "balancedneg_full20_20260729_161945",
                "status": "completed",
                "metric_source": "finetune_pet_best_test",
                "score": 0.7904537004194098,
                "test_precision": 0.9123116083206606,
                "test_recall": 0.8888888888888888,
                "test_map50": 0.9207728350626094,
                "test_map50_95": 0.7904537004194098,
                ...
                "best_epoch": 7,
                "epochs": 20,
                "started_at": "2026-07-29T08:30:41.556955",
                "finished_at": "2026-07-29T08:32:16.172183",
                "source_run": "/home/admin1/jgzj/.runtime/finetune/results/20260729_161945_pet_yolo_finetune_pet_balancedneg_full20",
                "best_weight": "/home/admin1/jgzj/.runtime/finetune/results/20260729_161945_pet_yolo_finetune_pet_balancedneg_full20/weights/best.pt",
                "run_count": 1,
            },
        ],
        "roots": [
    ...
    "fire_smoke_yolo": {
        ...
        "static_training_trends": [
            ...
            },
            {
                "day": "2026-07-27",
                "task_id": "fire_smoke_yolo",
                "model_family": "yolo12s_fire_smoke_nohard_round2_20260727_130839",
                "status": "completed",
                "metric_source": "manual_review_pool_test",
                "score": 0.40412,
                "test_precision": 0.71400,
                "test_recall": 0.60458,
                "test_map50": 0.63000,
                "test_map50_95": 0.40412,
                "val_precision": 0.77100,
                "val_recall": 0.62500,
                "val_map50": 0.69900,
                "val_map50_95": 0.48100,
                "started_at": "2026-07-27T13:10:10+08:00",
                "finished_at": "2026-07-27T13:11:04+08:00",
                "source_run": "/home/admin1/jgzj/.runtime/yolo_loop/runs/fire_smoke_yolo_fire_smoke_nohard_round2_20260727_130839",
                "best_weight": "/home/admin1/jgzj/.runtime/yolo_loop/runs/fire_smoke_yolo_fire_smoke_nohard_round2_20260727_130839/weights/best.pt",
                "download_file": "fire_smoke_yolo_nohard_round2_20260727_130839.pt",
                "local_weight": "/home/admin1/jgzj/.runtime/yolo_model_service/weights/fire_smoke_yolo_nohard_round2_20260727_130839.pt",
                "weight_sha256": "a3e41071b86c736bbb15f2ed9dd0cb926ba24bbacba6de499e9764ef81d570d2",
                "weight_size_bytes": 18903699,
                "run_count": 1,
            },
            {
                "day": "2026-07-27",
                "task_id": "fire_smoke_yolo",
                "model_family": "yolo12s_fire_smoke_full_review_full20_epoch20_20260727_155000",
                "status": "completed",
                "metric_source": "manual_review_pool_test_epoch20",
                "score": 0.55806,
                "test_precision": 0.87370,
                "test_recall": 0.62736,
                "test_map50": 0.72524,
                "test_map50_95": 0.55806,
                "val_precision": 0.76224,
                "val_recall": 0.65143,
                "val_map50": 0.74243,
                "val_map50_95": 0.50300,
                "started_at": "2026-07-27T15:47:34.585083+08:00",
                "finished_at": "2026-07-27T15:50:56.433623+08:00",
                "source_run": "/home/admin1/jgzj/.runtime/finetune/local_runs/fire_smoke_yolo/fire_smoke_yolo_fire_smoke_full_review_finetune_20260727_155000_fire_smoke_full_review_full20_fire_smoke_yolo_fire_smoke_full_review_20260727_155000_fire_smoke_full_review_full20_20260727_154734",
                "best_weight": "/home/admin1/jgzj/.runtime/finetune/local_runs/fire_smoke_yolo/fire_smoke_yolo_fire_smoke_full_review_finetune_20260727_155000_fire_smoke_full_review_full20_fire_smoke_yolo_fire_smoke_full_review_20260727_155000_fire_smoke_full_review_full20_20260727_154734/weights/last.pt",
                "checkpoint": "last.pt",
                "training_epoch": 20,
                "epochs": 20,
                "dataset_samples": 653,
                "dataset_positive": 380,
                "dataset_negative": 273,
                "run_count": 1,
            }
        ],
