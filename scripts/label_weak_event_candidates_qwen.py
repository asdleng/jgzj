...
CLASSES = ("fishing_rod", "pet", "stall", "bottle", "box", "paper", "bag", "fighting", "smoking")
...
TARGETS = {
    ...
    "fighting": {
        "classes": ("fighting",),
        "definition": "a clear real-person physical fight between humans, such as punching, kicking, grappling, wrestling, or aggressive body contact",
        "threshold": 0.90,
        "accept": re.compile(r"human|person|people|man|woman|fight|fighting|brawl|punch|kick|grappl|wrestl|aggressive|striking|physical_contact|people_grappling", re.I),
        "reject": re.compile(r"animal|dog|cat|bird|bull|horse|cockfight|crowd|queue|hug|helping|playing|dance|sport_match|martial_arts_training|performance|stage|poster|cartoon|animation|game|toy|statue|sculpture", re.I),
        "example_evidence": "two_people_grappling_in_physical_fight",
    },
    "smoking": {
        "classes": ("smoking",),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Two-pass Qwen review for weak-event web candidates.")
