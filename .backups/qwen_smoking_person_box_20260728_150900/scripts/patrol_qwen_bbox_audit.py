...
- fighting: a clear real-person physical fight between humans, such as punching, kicking, grappling, wrestling, or aggressive body contact. Animal fighting, toy/model scenes, animations, games, ordinary crowds, playing, hugging, helping, queueing, performances, martial-arts/sports training, or standing close are NOT fighting.
